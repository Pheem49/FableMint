...
function applyPatchOps(proj, ops) {
  ...
  for (const op of ops) {
    switch (op.op) {
      ...
      case "setProject": {
        const allowed = ["name", "width", "height", "fps", "background", "markers", "disabledTracks", "videoTracks", "audioTracks"];
